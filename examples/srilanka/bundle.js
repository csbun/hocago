...
/***/ function(module, exports, __webpack_require__) {
	...
	var srilankaData = __webpack_require__(162);

	var lk = new _2.default(document.getElementById('map'), srilankaData, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hocago = function () {
	  function Hocago(el, mapJson, opt) {
	    _classCallCheck(this, Hocago);
	  ...
	  _createClass(Hocago, [{
	    ...
	    key: 'point',
	    value: function point(opt) {
	      var _this = this;

	      if (opt instanceof Array) {
	        opt.map(function (optItem) {
	          return _this.point(optItem);
	        });
	      } else {
	        ...
	        try {
	          for (var _iterator = Object.keys(this._pointMap)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var key = _step.value;
	    ...
	    key: 'type',
	    value: function type(opt) {
	      var _this2 = this;

	      if (opt instanceof Array) {
	        opt.map(function (optItem) {
	          return _this2.type(optItem);
	        });
	      } else {
	        opt.type = 'lines';
	    ...
	    value: function line(opt) {
	      ...
	      if (opt instanceof Array) {
	        opt.map(function (optItem) {
	          return _this3.line(optItem);
	        });
	      } else {
	        if (this._typeIdxMap.hasOwnProperty(opt.type)) {
	          var fromCoord = this._pointMap[opt.from];
	          var toCoord = this._pointMap[opt.to];
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = __webpack_require__(5);
	    var ExtensionAPI = __webpack_require__(27);
	    var CoordinateSystemManager = __webpack_require__(28);
	    var OptionManager = __webpack_require__(29);

	    var ComponentModel = __webpack_require__(22);
	    var SeriesModel = __webpack_require__(30);

	    var ComponentView = __webpack_require__(31);
	    var ChartView = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Gradient = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    mixin(Model, __webpack_require__(15));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var getLineStyle = __webpack_require__(14)(
	        [
	            ['lineWidth', 'width'],
	            ['stroke', 'color'],
	            ['opacity'],
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        getAreaStyle: __webpack_require__(14)(
	            [
	                ['fill', 'color'],
	                ['shadowBlur'],
	                ['shadowOffsetX'],
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var vec2 = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        getItemStyle: __webpack_require__(14)(
	            [
	                ['fill', 'color'],
	                ['stroke', 'borderColor'],
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var componentUtil = __webpack_require__(23);
	    var clazzUtil = __webpack_require__(12);
	    ...
	    zrUtil.mixin(ComponentModel, __webpack_require__(25));
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Eventful = __webpack_require__(35);
	    var Transformable = __webpack_require__(36);
	    var Animatable = __webpack_require__(37);
	    var zrUtil = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Animator = __webpack_require__(38);
	    var util = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Clip = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var easingFuncs = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    graphic.BoundingRect = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var Path = __webpack_require__(47);
	    var PathProxy = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var Displayable = __webpack_require__(48);
	    var zrUtil = __webpack_require__(6);
	    var PathProxy = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	 ...
	 // TODO getTotalLength, getPointAtLength
	    ...
	    var vec2 = __webpack_require__(19);
	    var bbox = __webpack_require__(53);
	    var BoundingRect = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var CMD = __webpack_require__(51).CMD;
	    var line = __webpack_require__(55);
	    var cubic = __webpack_require__(56);
	    var quadratic = __webpack_require__(57);
	    var arc = __webpack_require__(58);
	    var normalizeRadian = __webpack_require__(59).normalizeRadian;
	    var curve = __webpack_require__(52);

	    var windingLine = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    module.exports = __webpack_require__(47).extend({
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var curveTool = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    echarts.registerLayout(__webpack_require__(116));

	    echarts.registerVisualCoding('chart', __webpack_require__(117));

	    echarts.registerProcessor('statistic', __webpack_require__(118));

	    echarts.registerPreprocessor(__webpack_require__(119));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var SeriesModel = __webpack_require__(30);
	    var zrUtil = __webpack_require__(6);
	    var completeDimensions = __webpack_require__(98);

	    var formatUtil = __webpack_require__(9);
	    var encodeHTML = formatUtil.encodeHTML;
	    var addCommas = formatUtil.addCommas;

	    var dataSelectableMixin = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var MapDraw = __webpack_require__(101);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var RoamController = __webpack_require__(102);
	    var graphic = __webpack_require__(45);
	    var zrUtil = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var zrUtil = __webpack_require__(6);
	    var eventTool = __webpack_require__(83);
	    var interactionMutex = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(6);
	    var roamHelper = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var Geo = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var parseGeoJson = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var polygonContain = __webpack_require__(111);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    echarts.registerVisualCoding('chart', zrUtil.curry(
	        __webpack_require__(129), 'scatter', 'circle', null
	    ));
	    echarts.registerLayout(zrUtil.curry(
	        __webpack_require__(130), 'scatter'
	    ));
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var zrUtil = __webpack_require__(6);
	    var modelUtil = __webpack_require__(8);
	    var CoordinateSystem = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var SymbolDraw = __webpack_require__(125);
	    var LargeSymbolDraw = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    var layout = __webpack_require__(24);
	    var axisHelper = __webpack_require__(133);

	    var zrUtil = __webpack_require__(6);
	    var Cartesian2D = __webpack_require__(139);
	    var Axis2D = __webpack_require__(141);
	    ...
	    __webpack_require__(28).register('cartesian2d', Grid);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var IntervalScale = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var zrUtil = __webpack_require__(6);
	    var Cartesian = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(6);
	    var Axis = __webpack_require__(142);
	    var axisLabelInterval = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var ComponentModel = __webpack_require__(22);
	    var zrUtil = __webpack_require__(6);
	    var axisModelCreator = __webpack_require__(146);
	    ...
	    zrUtil.merge(AxisModel.prototype, __webpack_require__(148));
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var axisDefault = __webpack_require__(147);
	    var zrUtil = __webpack_require__(6);
	    var ComponentModel = __webpack_require__(22);
	    var layout = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var zrUtil = __webpack_require__(6);
	    var graphic = __webpack_require__(45);
	    var AxisBuilder = __webpack_require__(151);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    echarts.registerVisualCoding(
	        'chart', zrUtil.curry(__webpack_require__(91), 'lines', 'lineStyle')
	    );
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var LineDraw = __webpack_require__(155);
	    var EffectLine = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var graphic = __webpack_require__(45);
	    var LineGroup = __webpack_require__(156);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var symbolUtil = __webpack_require__(127);
	    var vector = __webpack_require__(19);
	    var LinePath = __webpack_require__(157);
	    var graphic = __webpack_require__(45);
	    var zrUtil = __webpack_require__(6);
	    var numberUtil = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var curveUtil = __webpack_require__(52);
